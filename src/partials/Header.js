...
<ul className="flex flex-grow justify-end flex-wrap items-center">
  <li>
    <Link to="/features" className="text-black hover:text-purple-600 px-4 py-2 flex items-center transition duration-150 ease-in-out">
      Features
    </Link>
  </li>
  <li>
  ...
  <li>
    <Link to="/self" className="text-black hover:text-purple-600 px-4 py-2 flex items-center transition duration-150 ease-in-out">Self-Servie</Link>
  </li>
  {/* 1st level: hover */}
  <Dropdown title="Support">
    ...
    <li>
      <Link to="/help" className="font-medium text-sm text-white hover:text-purple-600 flex py-2 px-4 leading-tight">Help center</Link>
    </li>
    <li>
      <Link to="/404" className="font-medium text-sm text-white hover:text-purple-600 flex py-2 px-4 leading-tight">404</Link>
    </li>
  </Dropdown>
</ul>
